...
function doChange(changes: textChanges.ChangeTracker, sourceFile: SourceFile, info: Info) {
    ...
    changes.replaceNode(
        ...
        defaultImportName && !allowSyntheticDefaults
            ...
            : factory.createImportDeclaration(/*modifiers*/ undefined, factory.createImportClause(/*isTypeOnly*/ false, defaultImportName, namedImports), required, /*isProvided*/ false, /*attributes*/ undefined),
    );
}
